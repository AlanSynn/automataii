...
class LinuxBuilder:
    ...
    def create_appdir(self, exe_dir: Path):
        ...
        appdir_path = self.dist_dir / "MotionSmith.AppDir"
...
"""
        ...
        icon_file = appdir_path / "motionsmith.png"
    ...
    def create_appimage(self, appdir_path: Path, appimagetool_path: Path, update_info: str = None):
        ...
        appimage_path = self.dist_dir / "MotionSmith-x86_64.AppImage"
        ...
        for file in self.dist_dir.glob("MotionSmith-*.AppImage"):
            final_path = self.dist_dir / "MotionSmith-x86_64.AppImage"
            if file != final_path:
    ...
    def build(self, update_url: str = None, create_zsync: bool = True):
        ...
        try:
            ...
            update_info = None
            if update_url:
                update_info = f"zsync|{update_url}/MotionSmith-latest-x86_64.AppImage.zsync"
