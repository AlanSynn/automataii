#!/usr/bin/env python3
"""
Simple build script for MotionSmith that works with uv
...
class SimpleBuilder:
    def __init__(self, project_root: Path):
        ...
        self.spec_file = project_root / "packaging" / "pyinstaller" / "automataii.spec"
    ...
    def build_executable(self):
        ...
        if not self.spec_file.exists():
            ...
            logger.info("Generate spec file first with: pyinstaller --name MotionSmith src/automataii/__main__.py")
            return False
        ...
        # Check output
        if sys.platform == "darwin":
            output_path = self.dist_dir / "MotionSmith.app"
        elif sys.platform == "win32":
            output_path = self.dist_dir / "MotionSmith.exe"
        else:
            output_path = self.dist_dir / "MotionSmith"
    ...
    def build(self):
        ...
        logger.info("=== Starting MotionSmith Build ===")
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Simple build script for MotionSmith')
