...
def test_cam_final():
    ...
    print(f"   - Looking for foot/ankle joints specifically")
    print(f"   - If not found, using lowest joints")
    print(f"   - CAM placed 50 units below feet")
    print(f"   - X coordinate: average of foot joints")
    ...
    print(f"   - Follower Size: 20x15mm")
    
    print(f"\n6. Result:")
    print(f"   - CAM is much larger (150% scale)")
    print(f"   - CAM positioned 50 units below feet")
    print(f"   - Follower reaches near foot level")
    print(f"   - X coordinate based on foot joints average")
