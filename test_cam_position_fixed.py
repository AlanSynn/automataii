...
def test_cam_positioning():
    ...
    if cam_center_scene[1] > character_feet_y:
        print(f"   ✅ CAM is positioned below character feet")
    else:
        print(f"   ❌ CAM is NOT below character feet")
    
    if abs(follower_scene[1] - character_feet_y) < 50:
        print(f"   ✅ Follower is near character feet level")
    else:
        print(f"   ❌ Follower is too far from feet")
