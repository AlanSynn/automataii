...
pytest.skip(
    "Manual blueprint comprehensive test; skipping in automated pytest.", allow_module_level=True
)
...
def test_comprehensive_blueprint_fixes():
    ...
    try:
        ...
        _optimizer = BlueprintLayoutOptimizer(target_character_height_mm=300.0)
        ...
        if enhanced_mechanism:
            ...
            logger.info(
                f"   Dimensions: {enhanced_mechanism.bounds.width:.1f}×{enhanced_mechanism.bounds.height:.1f}mm"
            )
...
<svg width="400" height="300" xmlns="http://www.w3.org/2000/svg">
  {enhanced_mechanism.svg_content}
        ...
        logger.info(
            "   Open the SVG files in a web browser or SVG viewer to verify visual improvements"
        )
