# Four-Bar Editor Implementation
# Lines: ~250
# Public API: FourBarEditor
# Deps In: registry
# Deps Out: PyQt6, interfaces
# Coupling: Low (implements interface)
# Cohesion: Feature (4-bar editing)
# Owner: Alan Synn
...
from ..interfaces.handle import HandleConstraints
