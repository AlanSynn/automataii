...
class MechanismAnchorItem(QGraphicsEllipseItem):
    ...
    def __init__(self, anchor_id: str, center: QPointF, radius: float = 8.0, parent=None):
        super().__init__(center.x() - radius, center.y() - radius, radius * 2, radius * 2, parent)
    ...
    def set_center_pos(self, pos: QPointF):
        ...
        self.setRect(pos.x() - self.radius, pos.y() - self.radius, 
    ...
    def mouseReleaseEvent(self, event: QGraphicsSceneMouseEvent):
        ...
        if event.button() == Qt.MouseButton.LeftButton:
            ...
            self.signals.position_changed.emit(self.anchor_id, self.scenePos() + self.center_pos())
