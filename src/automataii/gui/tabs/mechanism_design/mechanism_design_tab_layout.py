...
# - Lines: ~300
# - Public API: setup_main_layout, create_control_panel, create_mechanism_view_area
# - Deps In (Afferent): 1 [MechanismDesignTab]
# - Deps Out (Efferent): 2 [PyQt6, EditorView]
# - Coupling: Low (UI creation only, no business logic)
# - Cohesion: Feature (UI layout management)
# - Owner: Phase 1 Refactoring, Reviewers: Architecture Team
...
class MechanismDesignTabLayout:
    ...
    def _create_mechanism_generation_group(self) -> QGroupBox:
        ...
        try:
            from automataii.gui.parametric_editor import ParametricEditor
