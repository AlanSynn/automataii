...
dataset_info = dict(
    dataset_name="coco",
    paper_info=_COCO_PAPER_INFO,
    keypoint_info=_COCO_KEYPOINT_INFO,
    skeleton_info=_COCO_SKELETON_INFO,
    joint_weights=[
        1.0,
        1.0,
        1.0,
...
data_cfg = dict(
    ...
    use_gt_bbox=True,
    det_bbox_thr=0.0,
    bbox_file="/private/home/hjessmith/AD_Consent_Data_workspace/mmpose-180k-workspace/train_size-180000_detections.json",
)
train_pipeline = [
    ...
    train=dict(
        ...
        dataset_info=dict(
            ...
            keypoint_info=dict(
                {
                    0: dict(
                        name="nose", id=0, color=[51, 153, 255], type="upper", swap=""
                    ),
                    1: dict(
                        name="left_eye",
                        id=1,
            ...
            skeleton_info=dict(
                {
                    ...
                    3: dict(
                        link=("right_knee", "right_hip"), id=3, color=[255, 128, 0]
                    ),
                    4: dict(link=("left_hip", "right_hip"), id=4, color=[51, 153, 255]),
                    5: dict(
                        link=("left_shoulder", "left_hip"), id=5, color=[51, 153, 255]
                    ),
                    6: dict(
                    ...
                    10: dict(
                        link=("left_elbow", "left_wrist"), id=10, color=[0, 255, 0]
                    ),
                    11: dict(
                        link=("right_elbow", "right_wrist"), id=11, color=[255, 128, 0]
                    ),
                    12: dict(
                        link=("left_eye", "right_eye"), id=12, color=[51, 153, 255]
                    ),
                    13: dict(link=("nose", "left_eye"), id=13, color=[51, 153, 255]),
                    14: dict(link=("nose", "right_eye"), id=14, color=[51, 153, 255]),
                    15: dict(
                        link=("left_eye", "left_ear"), id=15, color=[51, 153, 255]
                    ),
                    16: dict(
                        link=("right_eye", "right_ear"), id=16, color=[51, 153, 255]
                    ),
                    17: dict(
...
work_dir = (
    "/private/home/hjessmith/AD_Consent_Data_workspace/mmpose-180k-workspace/workdir"
)
