...
class StandardizedSkeletonModel(BaseModel):
    ...
    def get_joint(self, joint_id: str) -> StandardizedJointModel | None:
        """Helper to get a joint model by its ID."""
    ...
    def get_joint_parent(self, joint_id: str) -> StandardizedJointModel | None:
        ...
        if joint and joint.parent_id and joint.parent_id in self.joints:
            return self.joints[joint.parent_id]
        return None
