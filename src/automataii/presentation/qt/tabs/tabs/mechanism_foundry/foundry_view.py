...
Lines: ~400
Public API: MechanismFoundryView
Deps In: 0 [main app]
Deps Out: 6 [Qt, controller, mechanisms, renderer, core state]
Coupling: Low (uses controller + protocols)
Cohesion: Feature (foundry UI)
Owner: Alan Synn
