...
from .body_parts_extractor import TextureAwareSkeletonSegmenter
...
class InteractiveBodyEditor:
    ...
    def _find_nearest_joint(self, x: float, y: float, threshold: float = 20) -> Optional[str]:
...
def run_interactive_editing(image_path: str, skeleton_path: str = None):
    ...
    if skeleton_file.exists():
        ...
        print(f"Warning: No skeleton data found. Using default joint positions.")
