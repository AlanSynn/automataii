...
def annotations_to_animation(char_anno_dir: str, motion_cfg_fn: str, retarget_cfg_fn: str, use_image_sequence=False):
    """
    ...
    mvc_cfg = {
        ...
        'controller': {
            ...
            'OUTPUT_VIDEO_PATH': output_path}  # set the output location
    }
    ...
    try:
        ...
        if not use_image_sequence:
            ...
            annotations_to_animation(char_anno_dir, motion_cfg_fn, retarget_cfg_fn, use_image_sequence=True)
...
if __name__ == '__main__':
    ...
    use_image_sequence = os.environ.get('USE_IMAGE_SEQUENCE', '0').lower() in ('1', 'true', 'yes')
