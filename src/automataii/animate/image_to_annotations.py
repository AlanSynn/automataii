...
if __name__ == '__main__':
    ...
    if len(sys.argv) < 2:
        logger_main.error("Usage: python image_to_annotations.py <image_path> [output_base_dir]")
        sys.exit(1)
    ...
    if annotation_results:
        logger_main.info(f"Successfully generated annotations. Results: {annotation_results}")
