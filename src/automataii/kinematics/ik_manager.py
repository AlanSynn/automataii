    ...
    def _run_ik_animation_step(self):
        ...
        for component in self.sim_selectable_components:
            ...
            if part_info and part_info.motion_path_data:
                ...
                logging.debug(
                    f"IKManager._run_ik_animation_step: No motion path for component linked to IK joint abstract name '{target_ik_joint_abstract_name}'. Single-bone IK cannot be attempted without a target. Skipping for this component."
                )
