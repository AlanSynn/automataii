...
if __name__ == '__main__':
    ...
    cam_path_only = generate_cam_profile(center, path, follower_radius=5)
    ...
    # Test returning dict
    cam_data = generate_cam_profile(center, path, follower_radius=5, return_dict=True)
    if cam_data:
    ...
    default_cam_data = generate_cam_profile(
        QPointF(50,50),
        [], # No follower path
        follower_radius=0,
        return_dict=True,
