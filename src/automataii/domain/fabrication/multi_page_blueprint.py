...
from automataii.domain.fabrication.blueprint_optimizer import LayoutItem, ScaledBounds
...
class MultiPageBlueprintManager:
    ...
    def __init__(self, page_width_mm: float = 600.0, page_height_mm: float = 800.0):
        ...
        self.content_height_mm = (
            page_height_mm - self.title_height_mm - self.specs_height_mm - 40
        )  # margins
    ...
    def _group_mechanisms_by_type(
        self, mechanisms: list[LayoutItem]
    ...
    def _create_mechanism_type_pages(
        self, mech_type: str, mechanisms: list[LayoutItem], start_page: int
    ) -> list[BlueprintPage]:
    ...
    def _redistribute_mechanisms_on_page(
        self, mechanisms: list[LayoutItem], per_row: int
    ) -> list[LayoutItem]:
    ...
    def _create_assembly_overview_page(
        self, parts: list[LayoutItem], mechanisms: list[LayoutItem]
    ) -> BlueprintPage:
