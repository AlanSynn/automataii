...
class MotionDatabase:
    ...
    def _sample_mechanism_space(self, template: MechanismTemplate) -> list[PrecomputedMotionEntry]:
        """
    ...
    def load_database(self):
        ...
        db_path = resolve_path("src/automataii/domain/kinematics/generated_mechanism_paths.json")
        ...
        try:
            ...
            for item in data:
                ...
                try:
                    ...
                    numeric_params = [
                        v for v in item["parameters"].values() if isinstance(v, (int, float))
                    ]
