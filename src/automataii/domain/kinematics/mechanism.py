...
class MotionCurve:
    ...
    points: np.ndarray = field(default_factory=lambda: np.empty((0, 2)))  # Nx2 array of 2D points
    period: float = 0.0
    attachment_point: np.ndarray = field(default_factory=lambda: np.zeros(2))  # 2D point
