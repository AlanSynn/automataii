...
from automataii.core.events import ProjectLoadedEvent, ProjectSavedEvent
from automataii.core.serialization import Serializable
    ...
    def save(self, file_path: str | Path | None = None) -> None:
        ...
        try:
            ...
            with zipfile.ZipFile(
                temp_path, "w", zipfile.ZIP_DEFLATED, compresslevel=self.manifest.compression_level
            ) as archive:
                # Save manifest
