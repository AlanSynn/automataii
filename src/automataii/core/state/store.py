...
from typing import Any, Dict, List, Optional, Callable, Deque, TypeVar, Generic
from weakref import WeakSet

from .base import State, Action, Reducer, ActionTypes
...
def get_global_store() -> Optional[StateStore]:
