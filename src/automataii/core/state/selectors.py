...
import weakref
from typing import Any, Callable, Dict, Tuple, TypeVar, Generic, Optional
...
_global_registry: Optional[SelectorRegistry] = None
...
def get_current_user(state: State) -> Optional[Dict[str, Any]]:
...
def get_user_theme_preferences(user: Optional[Dict], theme: Dict) -> Dict[str, Any]:
