...
class QtTypeEncoder:
    ...
    def encode_qt_type(obj: Any) -> dict[str, Any]:
        ...
        if isinstance(obj, QPoint):
            ...
            return {"__qt_type__": "QSize", "width": obj.width(), "height": obj.height()}
    ...
    def default(self, obj: Any) -> Any:
        ...
        if isinstance(obj, bytes):
            if len(obj) > 1024:  # Large binary data
                ...
                return {"__binary_ref__": ref_id, "size": len(obj)}
            else:
                # Store as base64
...
class ProjectSerializer:
    ...
    def serialize(self, obj: Any, compress: bool = False, validate_schema: bool = True) -> bytes:
        """
    ...
    def deserialize(
        self, data: bytes, expected_type: type | None = None, compressed: bool = False
    ) -> Any:
        """
    ...
    def serialize_to_file(self, obj: Any, file_path: Path, compress: bool = False) -> None:
        """
    ...
    def deserialize_from_file(
        self, file_path: Path, expected_type: type | None = None, compressed: bool = False
    ) -> Any:
        """
