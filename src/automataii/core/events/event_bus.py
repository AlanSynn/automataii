...
from typing import (
    Dict, List, Set, Callable, Any, Optional, Type, 
    DefaultDict, Deque, Union
)
...
class EventBus:
    ...
    def unsubscribe(self, event_type: Type[Event], handler: Union[EventHandler, str]) -> bool:
        """
    ...
    def publish(self, event: Event, mode: Optional[EventProcessingMode] = None) -> None:
        """
