...
from automataii.core.app_container import setup_application_container, initialize_services, shutdown_application_container
from automataii.services.di import set_global_container
...
def main():
    ...
    main_window = AutomataDesigner(debug_mode=args.debug, experiment_mode=args.experiment, container=container)
    ...
    try:
        ...
        shutdown_application_container(container)
