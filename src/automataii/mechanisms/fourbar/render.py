...
Lines: 193
Public API: LinkageRenderer
Deps In: 0 [tests]
Deps Out: 4 [Qt, core state/protocols]
Coupling: Low (depends only on abstractions)
Cohesion: Feature (four-bar visualization)
Owner: Alan Synn
...
if TYPE_CHECKING:
    from automataii.mechanisms.core.state import ForceVector
